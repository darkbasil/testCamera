...
//        val latitude: Double = AGlanceLocationListener.getLatitude()
                    val latitude: Double = 65.0
//        val longitude: Double = AGlanceLocationListener.getLongitude()
                    val longitude: Double = 80.6
